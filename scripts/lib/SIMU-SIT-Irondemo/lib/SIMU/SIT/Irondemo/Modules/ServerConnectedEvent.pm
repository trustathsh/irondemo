package SIMU::SIT::Irondemo::Modules::ServerConnectedEvent;
...
<update lifetime="forever">
	...
	<metadata>
		<meta:event ifmap-cardinality="multiValue" xmlns:meta="http://www.trustedcomputinggroup.org/2010/IFMAP-METADATA/2">
                    ...
                    <type>other</type>
                    <other-type-definition>kvm switch connected</other-type-definition>
                    <information>KVM switch $kvm connected to server $server at $now</information>
                </meta:event>
	</metadata>
</update>
END_MESSAGE
