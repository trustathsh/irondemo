package SIMU::SIT::Irondemo::Modules::DoorClosedEvent;
...
<update lifetime="forever">
	...
	<metadata>
		<meta:event ifmap-cardinality="multiValue" xmlns:meta="http://www.trustedcomputinggroup.org/2010/IFMAP-METADATA/2">
                    ...
                    <type>other</type>
                    <other-type-definition>door closed</other-type-definition>
                    <information>Door $door closed at $now</information>
                </meta:event>
	</metadata>
</update>
END_MESSAGE
